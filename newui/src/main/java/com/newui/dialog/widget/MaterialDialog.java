package com.newui.dialog.widget;
...
import com.newui.dialog.utils.CornerUtils;
import com.newui.dialog.widget.internal.BaseAlertDialog;
...
public class MaterialDialog extends BaseAlertDialog<MaterialDialog> {
    ...
    public void setUiBeforShow() {
        ...
        ll_container.setBackground(CornerUtils.cornerDrawable(bgColor, radius));
        tv_btn_left.setBackground(CornerUtils.btnSelector(radius, bgColor, btnPressColor, -2));
        tv_btn_right.setBackground(CornerUtils.btnSelector(radius, bgColor, btnPressColor, -2));
        tv_btn_middle.setBackground(CornerUtils.btnSelector(radius, bgColor, btnPressColor, -2));
    }
}
