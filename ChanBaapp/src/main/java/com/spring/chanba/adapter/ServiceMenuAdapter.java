 ...
 * 工商服务
 */
public class ServiceMenuAdapter extends RecyclerView.Adapter<ServiceMenuAdapter.ViewHolder> {
    private Context mContext;
    private OnItemCallBack callBack;
    private List<ServiceMenuEntity.DataBean> dataList;

    public ServiceMenuAdapter(Context mContext, List<ServiceMenuEntity.DataBean> itemList) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        final ServiceMenuEntity.DataBean entity = dataList.get(position);
