...
import com.spring.chanba.presenter.BusinessServicePresenter;
 ...
 * 工商服务
 */
public class BusinessServiceActivity extends BaseActivity implements View.OnClickListener, BusinessServiceContract.View {
    private BusinessServiceContract.Presenter presenter;
    ...
    public void initView() {
        ...
        tvTitleHead.setText("工商服务");
        tvCaseName.setText("经典案例");
        tvLoreName.setText("工商知识");
    ...
    private void loadData() {
        showProgressDialog();
        presenter = new BusinessServicePresenter(this);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.img_title_back) {
            ...
            openNewActivity(BusinessServiceLoreActivity.class);

        } else if (i == R.id.tv_case_more) {
            openNewActivity(BusinessServiceCaseActivity.class);
            ...
            if (!Utils.isStringEmpty(entity.getData())) {
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(BusinessServiceActivity.this, AptitudeDetailActivity.class);
            ...
            if (!Utils.isStringEmpty(entity.getData())) {
                ...
                loreListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Log.i("BusinessServiceActivity", bean.getId());
                        Intent intent = new Intent(BusinessServiceActivity.this, BusinessServiceDetailActivity.class);
                        intent.putExtra("id", bean.getId());
                        intent.putExtra("flag", "1");
                        startActivity(intent);
                    }
    ...
    @Override
    public void setPresenter(BusinessServiceContract.Presenter presenter) {
