...
import com.spring.chanba.presenter.PropertyCaseDetailPresenter;
 ...
 * 财税：案例详情
 */
public class PropertyCaseDetailActivity extends BaseActivity implements PropertyCaseDetailContract.View {
    ...
    private String id;
    private PropertyCaseDetailContract.Presenter presenter;
    ...
    private void loadData() {
        ...
        map.put("id", id);
        presenter = new PropertyCaseDetailPresenter(this);
    ...
    @Override
    public void setPresenter(PropertyCaseDetailContract.Presenter presenter) {
