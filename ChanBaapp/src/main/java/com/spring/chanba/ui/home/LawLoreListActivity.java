...
import com.spring.chanba.presenter.LawLorePresenter;
 ...
 * 法律知识
 */
public class LawLoreListActivity extends BaseActivity implements LawLoreContract.View {
    private ImageButton imgTitleBack;
    private TextView tvTitleHead;
    private XRecyclerView recyclerView;
    private int pageNumber = 1;
    private LawLoreListAdapter adapter;
    private LawLoreContract.Presenter presenter;
    ...
    public void initView() {
        ...
        adapter.setOnItemClickListener(new LawLoreListAdapter.OnItemCallBack() {
            ...
            public void setOnClickListener(String id) {
                Intent intent = new Intent(LawLoreListActivity.this, WebViewLoreActivity.class);
    ...
    private void loadData() {
        ...
        map.put("pageSize", "10");
        presenter = new LawLorePresenter(this);
        presenter.getLawLore(map);
    }
    ...
    @Override
    public void setPresenter(LawLoreContract.Presenter presenter) {
