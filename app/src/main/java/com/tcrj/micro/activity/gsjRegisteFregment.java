...
public class gsjRegisteFregment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmetView = inflater.inflate(R.layout.registe_gr_fregment, container, false);
        initView();
        ...
        switch (v.getId()){
            ...
            case R.id.btn_true:
                ...
                if("".equals(sfz) || sfz.length() != 18){
                    ...
                    Toast.makeText(getContext(), "身份证号格式不正确", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                qyRegiste(namae,sfz,phone,dxyzm,Password);
                break;
    ...
    private void qyRegiste(String namae, String sfz, String phone, String dxyzm, String password) {
        ...
        params.put("type", 4);//注册类型 1.个人,2.个私企业,3.商务秘书公司,4.工商局内部
        params.put("tyshxydm", "");//企业：个私企统一信用代码
        params.put("frIdentity", "");//企业：法人身份证号
