package com.spring.chanba.banner;
...
public class XBanner extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    private int mLayoutResId = R.layout.item_banner;
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        customArcView = (CustomArcView) view.findViewById(R.id.banner_arcview);
    ...
    public XBanner setImageLoader(ImageLoaderInterface imageLoader) {
        this.imageLoader = imageLoader;
        return this;
    }

    public XBanner setDelayTime(int delayTime) {
        this.delayTime = delayTime;
        return this;
    }

    public void setIndicatorPadding(int left, int top, int right, int bottom) {
        indicator.setPadding(left, top, right, bottom);
    }

    public void setCustomerArcViewVisible(boolean visible) {
        if (visible == true) {
            customArcView.setVisibility(View.VISIBLE);
        } else {
            customArcView.setVisibility(View.GONE);
        }

    }


    public XBanner setIndicatorGravity(int type) {
        switch (type) {
    ...
    public XBanner setBannerAnimation(Class<? extends ViewPager.PageTransformer> transformer) {
        try {
     ...
     * @return Banner
     */
    public XBanner setOffscreenPageLimit(int limit) {
        if (viewPager != null) {
     ...
     * @return Banner
     */
    public XBanner setPageTransformer(boolean reverseDrawingOrder, ViewPager.PageTransformer transformer) {
        viewPager.setPageTransformer(reverseDrawingOrder, transformer);
        return this;
    }

    public XBanner setBannerTitles(List<String> titles) {
        this.titles = titles;
        return this;
    }

    public XBanner setBannerStyle(int bannerStyle) {
        this.bannerStyle = bannerStyle;
        return this;
    }

    public XBanner setViewPagerIsScroll(boolean isScroll) {
        this.isScroll = isScroll;
        return this;
    }

    public XBanner setImages(List<?> imageUrls) {
...
//        Log.i(tag,"currentItem: "+currentItem);
    ...
    @Deprecated
    public XBanner setOnBannerClickListener(OnBannerClickListener listener) {
     ...
     * @return
     */
    public XBanner setOnBannerListener(OnBannerListener listener) {
