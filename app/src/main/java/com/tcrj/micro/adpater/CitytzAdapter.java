 ...
 * date: 2017/9/27 .
 */
public class CitytzAdapter extends BaseQuickAdapter<jzfptzInfo.CityBean, BaseViewHolder> {
    private Context mContext;

    public CitytzAdapter(@Nullable List<jzfptzInfo.CityBean> data, Context context) {
    ...
    @Override
    protected void convert(final BaseViewHolder helper, jzfptzInfo.CityBean item) {

        helper.setText(R.id.city, item.getCountyName());
        ...
        helper.setText(R.id.cyfptsy, "参与扶贫体私营企业数量："+item.getTakePartInNum());
