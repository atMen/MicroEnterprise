...
public class BusinessCaseLoreAdapter extends RecyclerView.Adapter<BusinessCaseLoreAdapter.ViewHolder> {
    private Context mContext;
    private OnItemCallBack callBack;
    private List<LawServiceListEntity.DataBean> dataList;

    public BusinessCaseLoreAdapter(Context mContext, List<LawServiceListEntity.DataBean> itemList) {
