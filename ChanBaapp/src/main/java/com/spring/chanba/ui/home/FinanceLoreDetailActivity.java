...
import com.spring.chanba.presenter.FinanceLoreDetailPresenter;
 ...
 * 金融：金融知识
 */
public class FinanceLoreDetailActivity extends BaseActivity implements FinanceLoreDetailContract.View {
    ...
    private String id;
    private FinanceLoreDetailContract.Presenter presenter;
    ...
    private void loadData() {
        ...
        map.put("id", id);
        presenter = new FinanceLoreDetailPresenter(this);
    ...
    @Override
    public void setPresenter(FinanceLoreDetailContract.Presenter presenter) {
