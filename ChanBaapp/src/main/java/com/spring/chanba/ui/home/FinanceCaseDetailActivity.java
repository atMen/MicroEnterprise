...
import com.spring.chanba.presenter.FinanceCaseDetailPresenter;
 ...
 * 金融：经典案例
 */
public class FinanceCaseDetailActivity extends BaseActivity implements FinanceCaseDetailContract.View {
    ...
    private String id;
    private FinanceCaseDetailContract.Presenter presenter;
    ...
    private void loadData() {
        ...
        map.put("id", id);
        presenter = new FinanceCaseDetailPresenter(this);
    ...
    @Override
    public void setPresenter(FinanceCaseDetailContract.Presenter presenter) {
