...
import com.spring.chanba.presenter.PropertyTaxCasePresenter;
 ...
 * 财税：经典案例
 */
public class PropertyTaxCaseActivity extends BaseActivity implements PropertyTaxCaseContract.View {
    private ImageButton imgTitleBack;
    private TextView tvTitleHead;
    private XRecyclerView recyclerView;
    private int pageNumber = 1;
    private PropertyLoreCaseAdapter adapter;
    private PropertyTaxCaseContract.Presenter presenter;
    ...
    public void initView() {
        ...
        adapter.setOnItemClickListener(new PropertyLoreCaseAdapter.OnItemCallBack() {
            ...
            public void setOnClickListener(String id) {
                Intent intent = new Intent(PropertyTaxCaseActivity.this, PropertyCaseDetailActivity.class);
    ...
    private void loadData() {
        ...
        map.put("pageSize", "10");
        presenter = new PropertyTaxCasePresenter(this);
    ...
    @Override
    public void setPresenter(PropertyTaxCaseContract.Presenter presenter) {
