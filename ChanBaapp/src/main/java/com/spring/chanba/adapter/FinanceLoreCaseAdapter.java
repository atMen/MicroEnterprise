 ...
 * 金融：金融知识
 */
public class FinanceLoreCaseAdapter extends RecyclerView.Adapter<FinanceLoreCaseAdapter.ViewHolder> {
    private Context mContext;
    private OnItemCallBack callBack;
    private List<LawServiceListEntity.DataBean> dataList;

    public FinanceLoreCaseAdapter(Context mContext, List<LawServiceListEntity.DataBean> itemList) {
