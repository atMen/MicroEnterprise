...
import com.tcrj.micro.adpater.CountytzAdapter;
...
public class CountyTzInfoActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener, View.OnClickListener {
    ...
    private CountytzAdapter detailAdapter;

    private List<jzfptzInfo.CountyBean> beanList;//县
    ...
    public void initView() {
        ...
        mRecyclerView.setAdapter(detailAdapter = new CountytzAdapter(beanList, this));
...
//                        List<jzfptzInfo.ProvinceBean> province = response.getProvince();
                        ...
                        loadData(response.getCounty(),false);
    ...
    //下拉刷新
    private void loadData(List<jzfptzInfo.CountyBean> response,boolean isError) {
