...
public class LeftListActivity extends BaseActivity {
    ...
    public static LeftListAdapter adapter;
    ...
    public void initView() {
        ...
        adapter = new LeftListAdapter(this,list);
    ...
    class OnItemClick implements  OnItemClickListener{
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long lid) {
            ...
            Intent intent = new Intent(LeftListActivity.this,LeftDetailActivity.class);
        ...
        public void onClick(View v) {
            switch (v.getId()){
                ...
                case R.id.btnsearch:
                    ...
                    intent.setClass(LeftListActivity.this, LeftFindActivity.class);
                    startActivity(intent);
                    break;
            }
        }
