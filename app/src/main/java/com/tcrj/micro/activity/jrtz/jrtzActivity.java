...
public class jrtzActivity extends BaseActivity implements View.OnClickListener {
    ...
    private jrtzFragmentPagerAdapter myFragmentPagerAdapter;
    ...
    public void initView() {
        ...
        myFragmentPagerAdapter = new jrtzFragmentPagerAdapter(getSupportFragmentManager());
        mViewPager.setAdapter(myFragmentPagerAdapter);

        //将TabLayout和ViewPager绑定在一起，使双方各自的改变都能直接影响另一方，解放了开发人员对双方变动事件的监听
        mTabLayout.setupWithViewPager(mViewPager);
        txtTitle.setText("金融投资");
