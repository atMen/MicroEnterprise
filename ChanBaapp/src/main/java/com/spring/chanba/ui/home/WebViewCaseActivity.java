...
import com.spring.chanba.presenter.WebViewCasePresenter;
 ...
 * 法律案例
 */
public class WebViewCaseActivity extends BaseActivity implements WebViewCaseContract.View {
    ...
    private String id;
    private WebViewCaseContract.Presenter presenter;
    ...
    private void loadData() {
        ...
        map.put("id", id);
        presenter = new WebViewCasePresenter(this);
    ...
    @Override
    public void setPresenter(WebViewCaseContract.Presenter presenter) {
