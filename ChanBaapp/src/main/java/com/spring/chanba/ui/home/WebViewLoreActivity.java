...
import com.spring.chanba.presenter.WebViewLorePresenter;
 ...
 * 法律知识：详情
 */
public class WebViewLoreActivity extends BaseActivity implements WebViewLoreContract.View {
    ...
    private String id;
    private WebViewLoreContract.Presenter presenter;
    ...
    private void loadData() {
        ...
        map.put("id", id);
        presenter = new WebViewLorePresenter(this);
    ...
    @Override
    public void setPresenter(WebViewLoreContract.Presenter presenter) {
