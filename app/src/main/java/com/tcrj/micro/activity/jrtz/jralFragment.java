...
import com.tcrj.micro.activity.jzfp.WyfpActivity;
...
public class jralFragment extends BaseFragment implements BaseQuickAdapter.OnItemClickListener {

    public RecyclerView mRecyclerView;
    PtrFrameLayout mPtrFrameLayout;

    private MyOkHttp mMyOkhttp;
    private jralAdapter detailAdapter;
    ...
    private void getData(final int num) {
        ...
        mMyOkhttp.post()
                .url(ApiConstants.jrztbankallist_Api)
