...
public class jzfptzInfoActivity extends BaseActivity implements BaseQuickAdapter.OnItemClickListener, View.OnClickListener {
    ...
    private List<jzfptzInfo.ProvinceBean> beanList;//省
    private List<jzfptzInfo.CityBean> cityList;//市
    private List<jzfptzInfo.CountyBean> countyList;//县
