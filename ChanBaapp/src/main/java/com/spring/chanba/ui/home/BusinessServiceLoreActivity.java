...
import com.spring.chanba.presenter.BusinessServiceLorePresenter;
 ...
 * 工商知识
 */
public class BusinessServiceLoreActivity extends BaseActivity implements BusinessServiceLoreContract.View {
    private ImageButton imgTitleBack;
    private TextView tvTitleHead;
    private XRecyclerView recyclerView;
    private int pageNumber = 1;
    private BusinessCaseLoreAdapter adapter;
    private BusinessServiceLoreContract.Presenter presenter;
    ...
    public void initView() {
        ...
        adapter.setOnItemClickListener(new BusinessCaseLoreAdapter.OnItemCallBack() {
            ...
            public void setOnClickListener(String id) {
                Intent intent = new Intent(BusinessServiceLoreActivity.this, BusinessServiceDetailActivity.class);
    ...
    private void loadData() {
        ...
        map.put("pageSize", "10");
        map.put("type", "1");
        presenter = new BusinessServiceLorePresenter(this);
    ...
    @Override
    public void setPresenter(BusinessServiceLoreContract.Presenter presenter) {
