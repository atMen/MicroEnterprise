...
import com.spring.chanba.presenter.PropertyLoreDetailPresenter;
import com.spring.chanba.utils.Utils;
import com.spring.chanba.views.ObservableScrollView;

import java.util.HashMap;

public class PropertyLoreDetailActivity extends BaseActivity implements PropertyLoreDetailContract.View {
    ...
    private String id;
    private PropertyLoreDetailContract.Presenter presenter;
    ...
    private void loadData() {
        ...
        map.put("id", id);
        presenter = new PropertyLoreDetailPresenter(this);
    ...
    @Override
    public void initLore(FinanceServiceDetailEntity entity) {
        if (entity != null) {
    ...
    @Override
    public void setPresenter(PropertyLoreDetailContract.Presenter presenter) {
