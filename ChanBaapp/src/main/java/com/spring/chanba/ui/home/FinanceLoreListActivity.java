...
import com.spring.chanba.presenter.FinanceLorePresenter;
 ...
 * 金融：金融知识
 */
public class FinanceLoreListActivity extends BaseActivity implements FinanceLoreContract.View {
    private ImageButton imgTitleBack;
    private TextView tvTitleHead;
    private XRecyclerView recyclerView;
    private int pageNumber = 1;
    private FinanceLoreCaseAdapter adapter;
    private FinanceLoreContract.Presenter presenter;
    ...
    public void initView() {
        ...
        adapter.setOnItemClickListener(new FinanceLoreCaseAdapter.OnItemCallBack() {
            ...
            public void setOnClickListener(String id) {
                Intent intent = new Intent(FinanceLoreListActivity.this, FinanceLoreDetailActivity.class);
    ...
    private void loadData() {
        ...
        map.put("pageSize", "10");
        map.put("type", "1");
        presenter = new FinanceLorePresenter(this);
    ...
    @Override
    public void setPresenter(FinanceLoreContract.Presenter presenter) {
