package com.newui.dialog.utils;
...
public class CornerUtils {
     ...
     * (ListView鐨刬tem鐐瑰嚮鏁堟灉,鍙鐞嗘渶鍚庝竴椤瑰渾瑙掑鐞�)
     */
     ...
     * (ListView鐨刬tem鐐瑰嚮鏁堟灉,绗竴椤瑰拰鏈�鍚庝竴椤瑰渾瑙掑鐞�)
     */
    public static StateListDrawable listItemSelector(float radius, int normalColor, int pressColor, int itemTotalSize,
        ...
        if (itemPosition == 0 && itemPosition == itemTotalSize - 1) {// 鍙湁涓�椤�
