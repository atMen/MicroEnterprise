...
import com.spring.chanba.presenter.PropertyTaxPresenter;
 ...
 * 财税服务
 */
public class PropertyTaxActivity extends BaseActivity implements View.OnClickListener, PropertyTaxContract.View {
    private PropertyTaxContract.Presenter presenter;
    ...
    public void initView() {
        ...
        tvTitleHead.setText("财税服务");
        tvCaseName.setText("经典案例");
        tvLoreName.setText("财税知识");
    ...
    private void loadData() {
        showProgressDialog();
        presenter = new PropertyTaxPresenter(this);
    ...
    public void onClick(View v) {
        ...
        if (i == R.id.img_title_back) {
            ...
            openNewActivity(PropertyTaxLoreActivity.class);

        } else if (i == R.id.tv_case_more) {
            openNewActivity(PropertyTaxCaseActivity.class);
            ...
            if (!Utils.isStringEmpty(entity.getData())) {
                ...
                gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Intent intent = new Intent(PropertyTaxActivity.this, AptitudeDetailActivity.class);
            ...
            if (!Utils.isStringEmpty(entity.getData())) {
                ...
                loreListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Log.i("PropertyTaxLore---", bean.getId());
                        Intent intent = new Intent(PropertyTaxActivity.this, PropertyLoreDetailActivity.class);
                        intent.putExtra("id", bean.getId());
                        startActivity(intent);
                    }
                });
            ...
            if (!Utils.isStringEmpty(entity.getData())) {
                ...
                caseListview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        Log.i("PropertyTaxLore---", bean.getId());
                        Intent intent = new Intent(PropertyTaxActivity.this, PropertyCaseDetailActivity.class);
                        intent.putExtra("id", bean.getId());
                        startActivity(intent);
                    }
                });
    ...
    @Override
    public void setPresenter(PropertyTaxContract.Presenter presenter) {
